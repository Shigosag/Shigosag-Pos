...
export default function Dashboard() {
  ...
  const cards = [
    { title: "POS Sales", icon: <CreditCard size={28}/>, path: "/sales", color: "from-indigo-500 to-indigo-600", desc: "Process sales" },
  ...
  return (
    <div className="space-y-8 pb-10">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500 font-medium">System Terminal</p>
          </div>
        </div>
      ...
      <div className="bg-emerald-50 p-8 rounded-[32px] border border-emerald-100 flex justify-between items-center shadow-sm">
        <div>
          <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1">Total Balance</p>
